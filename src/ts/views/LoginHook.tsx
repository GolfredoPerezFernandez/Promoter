...
const serverUrl = "https://htsbg4ux7zlb.usemoralis.com:2053/server";
const appId = "ph6akLWjgvLQSkgeLW6Mx4Uziz5NsvtwohQu49yV";
      ...
      {cargando ? <RX.View> <RX.Text style={[_styles.Text3, { width: 200, marginTop: 50, textAlign: 'center', alignSelf: 'center', }]}>
        ...
        <RX.View>
          ...
          {register ? <RX.View style={{ paddingBottom: 50, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <UI.Button onPress={_onPressTodo} iconSlot={iconStyle => (
              <RX.Image source={ImageSource.metamask} style={{ marginTop: 0, marginBottom: 2, alignSelf: 'center', marginRight: 5, width: 18, height: 18 }} />
            )} style={{ root: [{ alignSelf: 'center', marginTop: 20 }], content: [{ width: 200, borderRadius: 11, }], label: _styles.label }
